...
export default function BreadcrumbPage_() {
  return (
    <div className="flex flex-col gap-12 p-8">
      ...
      <div className="flex flex-col gap-4">
        <SectionTitle>Custom Separator — Text</SectionTitle>
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink href="#">Home</BreadcrumbLink>
      ...
      {/* With Next.js Link */}
      <div className="flex flex-col gap-4">
        <SectionTitle>With Next.js Link</SectionTitle>
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
      ...
      {/* Long Breadcrumb */}
      <div className="flex flex-col gap-4">
        <SectionTitle>Long Breadcrumb</SectionTitle>
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink href="#">Home</BreadcrumbLink>
      ...
      <div className="flex flex-col gap-4">
        <SectionTitle>Long Breadcrumb with Ellipsis</SectionTitle>
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink href="#">Home</BreadcrumbLink>
