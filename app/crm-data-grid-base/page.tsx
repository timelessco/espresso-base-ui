            ...
            <DataGrid
              ...
              tableClassNames={{
                ...
                bodyRow: cn(
                  ...
                  "[&>td]:transition-colors [&:hover>td]:bg-input! [&:hover>td:first-child]:rounded-s-md [&:hover>td:last-child]:rounded-e-md [&[data-selected]>td]:bg-input!",
