    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "relative isolate z-50 max-h-(--available-height) w-auto min-w-(--anchor-width) origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-xl bg-card p-1 text-muted-foreground shadow-elevation-xl duration-100 [body:has([data-slot=card]_[data-slot=select-trigger][data-popup-open])_&]:bg-[color-mix(in_oklch,var(--card),white_3%)] [body:has([data-slot=dialog-content]_[data-slot=select-trigger][data-popup-open])_&]:bg-[color-mix(in_oklch,var(--card),white_3%)] [body:has([data-slot=popover-content]_[data-slot=select-trigger][data-popup-open])_&]:bg-[color-mix(in_oklch,var(--card),white_3%)] [body:has([data-slot=dialog-content]_[data-slot=card]_[data-slot=select-trigger][data-popup-open])_&]:bg-[color-mix(in_oklch,var(--card),white_13.5%)]! [body:has([data-slot=dialog-portal]_[data-slot=popover-content]_[data-slot=select-trigger][data-popup-open])_&]:bg-[color-mix(in_oklch,var(--card),white_13.5%)]! [body:has([data-slot=popover-content]_[data-slot=card]_[data-slot=select-trigger][data-popup-open])_&]:bg-[color-mix(in_oklch,var(--card),white_13.5%)]! [body:has([data-slot=card]_[data-slot=popover-trigger][data-popup-open]):has([data-slot=popover-content]_[data-slot=select-trigger][data-popup-open])_&]:bg-[color-mix(in_oklch,var(--card),white_13.5%)]! [body:has([data-slot=dialog-content]_[data-slot=card]_[data-slot=popover-trigger][data-popup-open]):has([data-slot=popover-content]_[data-slot=select-trigger][data-popup-open])_&]:bg-[color-mix(in_oklch,var(--card),white_18.5%)]! [body:has([data-slot=dialog-portal]_[data-slot=popover-content]_[data-slot=card]_[data-slot=select-trigger][data-popup-open])_&]:bg-[color-mix(in_oklch,var(--card),white_18.5%)]! data-[align-trigger=true]:animate-none data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
            className
          )}
          {...props}
        >
