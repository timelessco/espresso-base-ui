  ...
  return (
    <TabsPrimitive.Indicator
      ...
      className={cn(
        ...
        // vertical browser: erase the list's right divider beside the active
        // tab with a 1px strip, so the open edge stays clean without the
        // borders overhanging past the divider
        "group-data-[variant=browser]/tabs-list:group-data-vertical/tabs:after:absolute group-data-[variant=browser]/tabs-list:group-data-vertical/tabs:after:top-0 group-data-[variant=browser]/tabs-list:group-data-vertical/tabs:after:-right-px group-data-[variant=browser]/tabs-list:group-data-vertical/tabs:after:bottom-0 group-data-[variant=browser]/tabs-list:group-data-vertical/tabs:after:w-px group-data-[variant=browser]/tabs-list:group-data-vertical/tabs:after:bg-background",
        className
      )}
      {...props}
    />
