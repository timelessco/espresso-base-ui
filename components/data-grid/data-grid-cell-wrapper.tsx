...
export function DataGridCellWrapper<TData>({
  ...
  return (
    <div
      ...
      ref={composedRef}
      className={cn(
        "flex size-full items-center border-x border-transparent px-2 py-1.5 text-start text-base outline-none transition-colors group-hover/row:bg-input has-data-[slot=checkbox]:pt-2.5",
        {
