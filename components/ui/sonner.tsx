  ...
  return (
    <Sonner
      ...
      style={
        {
          "--normal-bg":
            "color-mix(in oklch, var(--primary), var(--background) 17%)",
      ...
      toastOptions={{
        classNames: {
          toast:
            "cn-toast data-[styled=true]:px-4! data-[styled=true]:py-2.5! data-[styled=true]:text-base! data-[styled=true]:leading-base! data-[styled=true]:font-medium! data-[styled=true]:tracking-wider! data-[styled=true]:shadow-3xl! data-[styled=true]:border-none! data-[styled=true]:has-[[data-close-button]]:pr-12! data-[styled=true]:gap-2!",
          description:
            "text-primary-foreground! text-base! leading-base! font-medium! tracking-wider!",
          actionButton:
            "bg-transparent! text-[var(--color-blue-400)]! p-0! text-base! leading-base! font-medium! tracking-wider!",
          closeButton:
