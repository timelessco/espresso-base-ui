  ...
  return (
    <Label
      ...
      className={cn(
        ...
        "[&:active_[data-slot=switch][data-size=sm]_[data-slot=switch-thumb]]:w-[13px]",
        "[&:active_[data-slot=switch][data-size=default]_[data-slot=switch-thumb]]:w-[15px]",
        "[&:active_[data-slot=switch][data-size=sm][data-checked]_[data-slot=switch-thumb]]:left-[10px]",
        "[&:active_[data-slot=switch][data-size=default][data-checked]_[data-slot=switch-thumb]]:left-[13px]",
