...
const cardVariants = cva(
  ...
  "group/card flex flex-col gap-4 overflow-hidden text-sm text-card-foreground shadow-default dark:shadow-[0px_1px_1px_#00000014,inset_0px_0px_0px_1px_#ffffff08] has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=lg]:gap-5 data-[size=sm]:gap-3 data-[size=xl]:gap-5 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl in-data-[slot=dialog-content]:bg-[color-mix(in_oklch,var(--card),white_3%)] in-data-[slot=popover-content]:bg-[color-mix(in_oklch,var(--card),white_3%)] in-data-[slot=command]:bg-[color-mix(in_oklch,var(--card),white_3%)] in-data-[slot=dialog-portal]:in-data-[slot=popover-content]:bg-[color-mix(in_oklch,var(--card),white_9.5%)]!",
  {
    variants: {
      variant: {
        default:
