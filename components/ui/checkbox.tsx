...
const checkboxVariants = cva(
  [
    "peer relative flex shrink-0 items-center justify-center rounded-2xs border border-transparent transition-all duration-[250ms] ease-[ease] outline-none after:absolute after:-inset-x-3 after:-inset-y-2 not-data-disabled:active:scale-[0.97] not-data-disabled:data-pressed:scale-[0.97] data-disabled:pointer-events-none data-disabled:cursor-not-allowed data-disabled:border-[color-mix(in_oklch,var(--primary),var(--background)_79%)] data-disabled:bg-[color-mix(in_oklch,var(--primary),var(--background)_97%)] data-disabled:data-checked:border-[color-mix(in_oklch,var(--primary),var(--background)_93%)] data-disabled:data-checked:bg-[color-mix(in_oklch,var(--primary),var(--background)_93%)] data-disabled:data-checked:[&_svg]:text-card-foreground dark:data-disabled:border-[color-mix(in_oklch,var(--primary),var(--background)_67%)] dark:data-disabled:bg-[color-mix(in_oklch,var(--primary),var(--background)_96%)] dark:data-disabled:data-checked:border-[color-mix(in_oklch,var(--primary),var(--background)_84%)] dark:data-disabled:data-checked:bg-[color-mix(in_oklch,var(--primary),var(--background)_84%)]",
    // unchecked states
    "data-unchecked:border-[color-mix(in_oklch,var(--primary),var(--background)_60%)] dark:data-unchecked:border-[color-mix(in_oklch,var(--primary),var(--background)_56%)] not-data-disabled:data-unchecked:hover:border-[color-mix(in_oklch,var(--primary),var(--background)_48%)] dark:not-data-disabled:data-unchecked:hover:border-[color-mix(in_oklch,var(--primary),var(--background)_52%)] not-data-disabled:data-unchecked:hover:shadow-elevation-sm not-data-disabled:data-unchecked:focus-visible:border-primary not-data-disabled:data-unchecked:focus-visible:ring-2 not-data-disabled:data-unchecked:focus-visible:ring-ring not-data-disabled:data-unchecked:active:border-muted-foreground",
    // checked states
