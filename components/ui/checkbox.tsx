...
const checkboxVariants = cva(
  [
    ...
    // unchecked states
    "data-unchecked:border-[color-mix(in_oklch,var(--primary),var(--background)_60%)] dark:data-unchecked:border-[color-mix(in_oklch,var(--primary),var(--background)_56%)] not-data-disabled:data-unchecked:hover:border-accent-foreground not-data-disabled:data-unchecked:hover:shadow-elevation-sm not-data-disabled:data-unchecked:focus-visible:border-primary not-data-disabled:data-unchecked:focus-visible:ring-2 not-data-disabled:data-unchecked:focus-visible:ring-ring not-data-disabled:data-unchecked:active:border-muted-foreground",
    // checked states
