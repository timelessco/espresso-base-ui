...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      data-variant={variant}
      className={cn(
        "flex flex-wrap items-center gap-1.5 rounded-lg bg-clip-padding px-2.5 py-1 text-sm transition-colors has-aria-invalid:ring-3 has-aria-invalid:ring-destructive/20 has-data-[slot=combobox-chip]:px-1 dark:has-aria-invalid:ring-destructive/40",
        // outline variant
