...
function Toast({ className, ...props }: ToastPrimitive.Root.Props) {
  return (
    <ToastPrimitive.Root
      data-slot="toast"
      className={cn(
        "group/toast pointer-events-auto absolute right-0 bottom-0 z-[calc(1000-var(--toast-index))] w-full origin-bottom rounded-[var(--radius)] bg-[color-mix(in_oklch,var(--primary),var(--background)_17%)] text-primary-foreground shadow-elevation-md will-change-transform outline-none select-none focus-visible:ring-[3px] focus-visible:ring-ring/50",
