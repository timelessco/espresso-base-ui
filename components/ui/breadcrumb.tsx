...
function BreadcrumbList({ className, ...props }: React.ComponentProps<"ol">) {
  return (
    <ol
      ...
      className={cn(
        "flex flex-wrap items-center gap-0.5 text-base leading-base tracking-normal wrap-break-word text-accent-foreground group-data-[size=md]/breadcrumb:text-lg group-data-[size=md]/breadcrumb:font-medium",
        className
      )}
      {...props}
    />
...
function BreadcrumbLink({
  ...
  return useRender({
    ...
    props: mergeProps<"a">(
      {
        className: cn(
          "flex h-7 items-center rounded-md px-2 transition-colors outline-none group-data-[size=md]/breadcrumb:px-[5px] hover:bg-muted focus-visible:bg-secondary focus-visible:ring-2 focus-visible:ring-ring active:bg-transparent active:text-secondary-foreground active:ring-0",
          className
        ),
      },
      props
